...
- **[services/dbt/macros](../../macros/CONTEXT.md)** — Provides delta_source and source_with_empty_guard macros used by all staging models
- **[services/spark-streaming](../../../spark-streaming/CONTEXT.md)** — Data source; staging reads from Bronze Delta tables created by streaming jobs
