...
- `simulation` — SimPy discrete-event engine generating rideshare events; exposes FastAPI for control
...
- `control-panel` — React/TypeScript frontend with deck.gl map and WebSocket real-time updates
...
- `trino` — Distributed SQL query engine over Delta Lake tables
...
- `grafana` — Dashboards combining Prometheus, Loki, Tempo, and Trino datasources
