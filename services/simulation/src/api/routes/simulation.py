...
def change_speed(
    ...
    """Change simulation speed multiplier (must be >= 0.0625)."""
    if body.multiplier < 0.0625:
        raise HTTPException(status_code=400, detail="Invalid multiplier. Must be >= 0.0625")
