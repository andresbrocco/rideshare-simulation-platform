...
class OfferTimeoutManager:
    ...
    def start_offer_timeout(self, trip, driver_id: str, offer_sequence: int):
    ...
    def _timeout_process(self, trip_id: str):
        try:
    ...
    def _emit_expiration_event(self, pending_offer: PendingOffer):
        event_data = {
        ...
        self.kafka_producer.produce(topic="trip.offer_expired", value=event_data)

    def clear_offer(self, trip_id: str, reason: str):
        if trip_id in self.pending_offers:
            pending_offer = self.pending_offers[trip_id]
    ...
    def invalidate_offer(self, trip_id: str):
