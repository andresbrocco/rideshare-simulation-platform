...
class TestFareCalculator:
    ...
    def test_fare_minimum_enforced(self, calculator):
        breakdown = calculator.calculate(
            distance_km=1.0, duration_min=1.0, surge_multiplier=1.0
        )
    ...
    def test_fare_with_surge(self, calculator):
        breakdown = calculator.calculate(
            distance_km=10.0, duration_min=20.0, surge_multiplier=2.0
        )
    ...
    def test_fare_minimum_with_surge(self, calculator):
        breakdown = calculator.calculate(
            distance_km=0.5, duration_min=1.0, surge_multiplier=1.5
        )
    ...
    def test_fare_breakdown(self, calculator):
        breakdown = calculator.calculate(
            distance_km=8.0, duration_min=15.0, surge_multiplier=1.0
        )
    ...
    def test_fare_zero_distance(self, calculator):
        breakdown = calculator.calculate(
            distance_km=0.0, duration_min=5.0, surge_multiplier=1.0
        )
    ...
    def test_fare_invalid_surge(self, calculator):
        with pytest.raises(ValueError):
            calculator.calculate(
                distance_km=5.0, duration_min=10.0, surge_multiplier=0.5
            )
