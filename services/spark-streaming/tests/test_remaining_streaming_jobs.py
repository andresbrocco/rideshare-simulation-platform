...
def get_result_schema_surge_updates(result_df: MagicMock) -> StructType:
    ...
    from schemas.lakehouse.schemas.bronze_tables import bronze_surge_updates_schema
...
def get_result_schema_ratings(result_df: MagicMock) -> StructType:
    ...
    from schemas.lakehouse.schemas.bronze_tables import bronze_ratings_schema
...
def get_result_schema_payments(result_df: MagicMock) -> StructType:
    ...
    from schemas.lakehouse.schemas.bronze_tables import bronze_payments_schema
...
def get_result_schema_driver_profiles(result_df: MagicMock) -> StructType:
    ...
    from schemas.lakehouse.schemas.bronze_tables import bronze_driver_profiles_schema
...
def get_result_schema_rider_profiles(result_df: MagicMock) -> StructType:
    ...
    from schemas.lakehouse.schemas.bronze_tables import bronze_rider_profiles_schema
