...
![Docker Compose Dependencies](out-dark/infra-01-docker-compose.svg)
...
![Secrets Flow](out-dark/infra-02-secrets-flow.svg)
...
![K8s Resource Topology](out-dark/infra-03-k8s-topology.svg)
...
![Terraform Layers](out-dark/infra-04-terraform-layers.svg)
...
![Network Access Paths](out-dark/infra-05-network-paths.svg)
...
![CI/CD Pipeline](out-dark/infra-06-cicd-pipeline.svg)
...
![IAM Chains](out-dark/infra-07-iam-chains.svg)
...
![Kustomize Composition](out-dark/infra-08-kustomize.svg)
...
![ArgoCD Loop](out-dark/infra-09-argocd.svg)
...
![EKS Bootstrap](out-dark/infra-10-eks-bootstrap.svg)
