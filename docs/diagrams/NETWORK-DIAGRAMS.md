...
![VPC Topology](out-dark/net-01-vpc-topology.svg)
...
![DNS & ALB Routing](out-dark/net-02-dns-alb-routing.svg)
...
![K8s Internal Networking](out-dark/net-03-k8s-internal.svg)
...
![Security Group Chain](out-dark/net-04a-security-groups.svg)
...
![Pod Identity Associations](out-dark/net-04b-pod-identity.svg)
