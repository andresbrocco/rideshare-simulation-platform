...
from streaming.tests.fixtures.mock_kafka import (
    create_mock_kafka_df,
    extract_all_event_ids,
)
from streaming.tests.fixtures.test_data import (
...
class TestCheckpointOffsetTracking:
    ...
    def test_checkpoint_preserves_kafka_partition_and_offset(self):
        ...
        from streaming.tests.fixtures.mock_kafka import extract_written_data
