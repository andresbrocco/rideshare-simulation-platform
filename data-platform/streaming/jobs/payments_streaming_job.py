"""Streaming job for payments topic ingestion to Bronze layer."""
...
class PaymentsStreamingJob(BaseStreamingJob):
    """Streaming job for payments topic."""
    ...
    def bronze_table_path(self) -> str:
        return "s3a://rideshare-bronze/bronze_payments/"
...
if __name__ == "__main__":
    ...
    error_handler = ErrorHandler(dlq_table_path="s3a://rideshare-bronze/dlq_payments/")
