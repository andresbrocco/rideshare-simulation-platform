...
print("\nCreating bronze_trips with sample data...")
cursor.execute(
    """
...
print("\nCreating bronze_gps_pings with sample data...")
cursor.execute(
    """
...
print("\nCreating bronze_driver_status with sample data...")
cursor.execute(
    """
...
print("\n✓ All Bronze tables created successfully with sample data!")
